...
async function main() {
  ...
  const harvester = await Harvester.deploy(treasury, process.env.ROUTER_ADDRESS || "0x2626664c2603336E57B271c5C0b26F421741e481", process.env.DRB_TOKEN || "0xd7f5d9d299a18a17e5cc6f7ff44e1f5a0165349c", weth);
